...
int realmain(int argc, char** argv)
{
    ...
    if (!headless)
    {
        ...
        std::unique_ptr<LogListModel> listModel = std::make_unique<LogListModel>();
        ...
        std::unique_ptr<UiHandler> opHandler = std::make_unique<UiHandler>(&engine, app.activeWindow()); 
