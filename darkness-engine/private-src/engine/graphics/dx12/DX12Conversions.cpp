    ...
    namespace implementation
    {
        ...
        D3D12_RESOURCE_DIMENSION dxResourceDimension(ResourceDimension dim)
        {
            switch (dim)
            {
                ...
                case ResourceDimension::TextureCubemap: return D3D12_RESOURCE_DIMENSION_TEXTURE2D;
                case ResourceDimension::TextureCubemapArray: return D3D12_RESOURCE_DIMENSION_TEXTURE2D;
            }
        ...
        D3D12_COMMAND_LIST_TYPE dxCommandListType(CommandListType type)
        {
            switch (type)
            {
                ...
                case CommandListType::Transfer: return D3D12_COMMAND_LIST_TYPE_COPY;
            }
        ...
        CommandListType fromDXCommandListType(D3D12_COMMAND_LIST_TYPE type)
        {
            switch (type)
            {
                ...
                case D3D12_COMMAND_LIST_TYPE_COPY: return CommandListType::Transfer;
                case D3D12_COMMAND_LIST_TYPE_BUNDLE: ASSERT(false);
            }
