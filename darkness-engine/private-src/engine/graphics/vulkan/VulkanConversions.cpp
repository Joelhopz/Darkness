    ...
    namespace implementation
    {
        ...
        VkFormat vulkanFormat(Format format)
        {
            switch (format)
            {
                ...
                case Format::420_OPAQUE: return VK_FORMAT_UNDEFINED;
        ...
        VkImageType vulkanDimension(ResourceDimension dimension)
        {
            switch (dimension)
            {
                ...
                case ResourceDimension::TextureCubemap: return VkImageType::VK_IMAGE_TYPE_2D;
            }
        ...
        Format fromVulkanFormat(VkFormat format)
        {
            switch(format)
            {
                ...
                case VK_FORMAT_RANGE_SIZE: return Format::UNKNOWN;
