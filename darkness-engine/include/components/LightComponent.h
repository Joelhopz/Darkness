...
namespace engine
{
    ...
    private:
        ...
        std::vector<std::shared_ptr<Property>> m_optionals;
    public:
        LightComponent()
        ...
        void populateOptionals()
        {
            ...
            switch (m_type.value<LightType>())
            {
                ...
                case LightType::Spot:
                {
                    m_optionals.emplace_back(std::make_shared<Property>( this, "inner cone angle", 30.0f, [this]() { this->m_innerConeChanged = true; } ));
                    m_optionals.emplace_back(std::make_shared<Property>( this, "outer cone angle", 33.0f, [this]() { this->m_outerConeChanged = true; } ));
