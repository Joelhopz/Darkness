...
namespace engine
{
    ...
    struct BlendDescription
    {
        struct
        {
            ...
            {
                RenderTargetBlendDescription{ false, false, Blend::SrcAlpha, Blend::InvSrcAlpha, BlendOperation::Add, Blend::One, Blend::InvSrcAlpha, BlendOperation::Add, LogicOperation::Clear, 0 },
                RenderTargetBlendDescription{ false, false, Blend::SrcAlpha, Blend::InvSrcAlpha, BlendOperation::Add, Blend::One, Blend::InvSrcAlpha, BlendOperation::Add, LogicOperation::Clear, 0 },
                RenderTargetBlendDescription{ false, false, Blend::SrcAlpha, Blend::InvSrcAlpha, BlendOperation::Add, Blend::One, Blend::InvSrcAlpha, BlendOperation::Add, LogicOperation::Clear, 0 },
                RenderTargetBlendDescription{ false, false, Blend::SrcAlpha, Blend::InvSrcAlpha, BlendOperation::Add, Blend::One, Blend::InvSrcAlpha, BlendOperation::Add, LogicOperation::Clear, 0 },
                RenderTargetBlendDescription{ false, false, Blend::SrcAlpha, Blend::InvSrcAlpha, BlendOperation::Add, Blend::One, Blend::InvSrcAlpha, BlendOperation::Add, LogicOperation::Clear, 0 },
    ...
    struct DepthStencilDescription
    {
        struct
        {
            ...
            DepthStencilOpDescription frontFace = { StencilOp::Keep, StencilOp::Keep, StencilOp::Keep, ComparisonFunction::Never };
            DepthStencilOpDescription backFace = { StencilOp::Keep, StencilOp::Keep, StencilOp::Keep, ComparisonFunction::Never };
        } desc;
