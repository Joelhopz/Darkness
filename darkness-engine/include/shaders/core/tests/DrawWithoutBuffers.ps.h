...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        class DrawWithoutBuffersPS : public PixelShader
            {
        public:

            DrawWithoutBuffersPS();

            DrawWithoutBuffersPS(const DrawWithoutBuffersPS&);
            DrawWithoutBuffersPS(DrawWithoutBuffersPS&&);
            DrawWithoutBuffersPS& operator=(const DrawWithoutBuffersPS&);
            DrawWithoutBuffersPS& operator=(DrawWithoutBuffersPS&&);
