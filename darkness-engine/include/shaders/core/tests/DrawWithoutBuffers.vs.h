...
namespace engine
{
    ...
    namespace shaders
    {
        class DrawWithoutBuffers;

        class DrawWithoutBuffersVS : public VertexShader
            {
        public:

            DrawWithoutBuffersVS();

            DrawWithoutBuffersVS(const DrawWithoutBuffersVS&);
            DrawWithoutBuffersVS(DrawWithoutBuffersVS&&);
            DrawWithoutBuffersVS& operator=(const DrawWithoutBuffersVS&);
            DrawWithoutBuffersVS& operator=(DrawWithoutBuffersVS&&);
        ...
        private:
            friend class DrawWithoutBuffers;
