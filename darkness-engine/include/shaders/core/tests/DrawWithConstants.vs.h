...
namespace engine
{
    ...
    namespace shaders
    {
        class DrawWithConstants;

        namespace drawwithconstantsvs_namespace
        {
        ...
        struct constants_struct2
            {
                Float4 color3;
                };
        }
        class DrawWithConstantsVS : public VertexShader
            , public drawwithconstantsvs_namespace::constants_struct
            , public drawwithconstantsvs_namespace::constants_struct2
            {
        public:

            DrawWithConstantsVS();

            DrawWithConstantsVS(const DrawWithConstantsVS&);
            DrawWithConstantsVS(DrawWithConstantsVS&&);
            DrawWithConstantsVS& operator=(const DrawWithConstantsVS&);
            DrawWithConstantsVS& operator=(DrawWithConstantsVS&&);
        ...
        private:
            friend class DrawWithConstants;
