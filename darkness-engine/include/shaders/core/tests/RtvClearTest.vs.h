...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        class RtvClearTestVS : public VertexShader
            {
        public:

            RtvClearTestVS();

            RtvClearTestVS(const RtvClearTestVS&);
            RtvClearTestVS(RtvClearTestVS&&);
            RtvClearTestVS& operator=(const RtvClearTestVS&);
            RtvClearTestVS& operator=(RtvClearTestVS&&);
