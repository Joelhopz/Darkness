...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        class MrtVisualizePS : public PixelShader
            {
        public:

            MrtVisualizePS();

            MrtVisualizePS(const MrtVisualizePS&);
            MrtVisualizePS(MrtVisualizePS&&);
            MrtVisualizePS& operator=(const MrtVisualizePS&);
            MrtVisualizePS& operator=(MrtVisualizePS&&);

            TextureBindlessSRV mrt;
