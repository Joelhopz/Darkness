...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        class DrawWithTexturePS : public PixelShader
            {
        public:

            DrawWithTexturePS();

            DrawWithTexturePS(const DrawWithTexturePS&);
            DrawWithTexturePS(DrawWithTexturePS&&);
            DrawWithTexturePS& operator=(const DrawWithTexturePS&);
            DrawWithTexturePS& operator=(DrawWithTexturePS&&);
