...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        namespace mrtvisualizevs_namespace
        {
        struct ConstData
            {
                Float width;
        ...
        class MrtVisualizeVS : public VertexShader
            , public mrtvisualizevs_namespace::ConstData
            {
        public:

            MrtVisualizeVS();

            MrtVisualizeVS(const MrtVisualizeVS&);
            MrtVisualizeVS(MrtVisualizeVS&&);
            MrtVisualizeVS& operator=(const MrtVisualizeVS&);
            MrtVisualizeVS& operator=(MrtVisualizeVS&&);
