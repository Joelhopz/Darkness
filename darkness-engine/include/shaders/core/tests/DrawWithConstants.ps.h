...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        class DrawWithConstantsPS : public PixelShader
            {
        public:

            DrawWithConstantsPS();

            DrawWithConstantsPS(const DrawWithConstantsPS&);
            DrawWithConstantsPS(DrawWithConstantsPS&&);
            DrawWithConstantsPS& operator=(const DrawWithConstantsPS&);
            DrawWithConstantsPS& operator=(DrawWithConstantsPS&&);
