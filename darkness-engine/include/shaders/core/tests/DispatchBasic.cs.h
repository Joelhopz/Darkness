...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        namespace dispatchbasiccs_namespace
        {
        ...
        class DispatchBasicCS : public ComputeShader
            , public dispatchbasiccs_namespace::DispatchConstants
            {
        public:

            DispatchBasicCS();

            DispatchBasicCS(const DispatchBasicCS&);
            DispatchBasicCS(DispatchBasicCS&&);
            DispatchBasicCS& operator=(const DispatchBasicCS&);
            DispatchBasicCS& operator=(DispatchBasicCS&&);
