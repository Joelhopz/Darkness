...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        class RtvClearTestPS : public PixelShader
            {
        public:

            RtvClearTestPS();

            RtvClearTestPS(const RtvClearTestPS&);
            RtvClearTestPS(RtvClearTestPS&&);
            RtvClearTestPS& operator=(const RtvClearTestPS&);
            RtvClearTestPS& operator=(RtvClearTestPS&&);

            TextureSRV sourceLod;
