...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        class DrawWithPixelShaderResourcesPS : public PixelShader
            {
        public:

            DrawWithPixelShaderResourcesPS();

            DrawWithPixelShaderResourcesPS(const DrawWithPixelShaderResourcesPS&);
            DrawWithPixelShaderResourcesPS(DrawWithPixelShaderResourcesPS&&);
            DrawWithPixelShaderResourcesPS& operator=(const DrawWithPixelShaderResourcesPS&);
            DrawWithPixelShaderResourcesPS& operator=(DrawWithPixelShaderResourcesPS&&);
