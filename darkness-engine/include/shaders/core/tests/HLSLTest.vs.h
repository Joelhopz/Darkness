...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        class HLSLTestVS : public VertexShader
            {
        public:

            HLSLTestVS();

            HLSLTestVS(const HLSLTestVS&);
            HLSLTestVS(HLSLTestVS&&);
            HLSLTestVS& operator=(const HLSLTestVS&);
            HLSLTestVS& operator=(HLSLTestVS&&);
