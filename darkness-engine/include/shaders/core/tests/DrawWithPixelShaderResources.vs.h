...
namespace engine
{
    ...
    namespace shaders
    {
        class DrawWithPixelShaderResources;

        class DrawWithPixelShaderResourcesVS : public VertexShader
            {
        public:

            DrawWithPixelShaderResourcesVS();

            DrawWithPixelShaderResourcesVS(const DrawWithPixelShaderResourcesVS&);
            DrawWithPixelShaderResourcesVS(DrawWithPixelShaderResourcesVS&&);
            DrawWithPixelShaderResourcesVS& operator=(const DrawWithPixelShaderResourcesVS&);
            DrawWithPixelShaderResourcesVS& operator=(DrawWithPixelShaderResourcesVS&&);
        ...
        private:
            friend class DrawWithPixelShaderResources;
