...
namespace engine
{
    ...
    namespace shaders
    {
        class Texture2DArrayVisualizer;

        namespace texture2darrayvisualizervs_namespace
        {
        struct ConstData
            {
                Uint slices;
        ...
        class Texture2DArrayVisualizerVS : public VertexShader
            , public texture2darrayvisualizervs_namespace::ConstData
            {
        public:

            Texture2DArrayVisualizerVS();

            Texture2DArrayVisualizerVS(const Texture2DArrayVisualizerVS&);
            Texture2DArrayVisualizerVS(Texture2DArrayVisualizerVS&&);
            Texture2DArrayVisualizerVS& operator=(const Texture2DArrayVisualizerVS&);
            Texture2DArrayVisualizerVS& operator=(Texture2DArrayVisualizerVS&&);
        ...
        private:
            friend class Texture2DArrayVisualizer;
