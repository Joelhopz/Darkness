...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        namespace drawwithtexturevs_namespace
        {
        struct ConstData
            {
                Float width;
        ...
        class DrawWithTextureVS : public VertexShader
            , public drawwithtexturevs_namespace::ConstData
            {
        public:

            DrawWithTextureVS();

            DrawWithTextureVS(const DrawWithTextureVS&);
            DrawWithTextureVS(DrawWithTextureVS&&);
            DrawWithTextureVS& operator=(const DrawWithTextureVS&);
            DrawWithTextureVS& operator=(DrawWithTextureVS&&);
