...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        class Texture2DArrayVisualizerPS : public PixelShader
            {
        public:

            Texture2DArrayVisualizerPS();

            Texture2DArrayVisualizerPS(const Texture2DArrayVisualizerPS&);
            Texture2DArrayVisualizerPS(Texture2DArrayVisualizerPS&&);
            Texture2DArrayVisualizerPS& operator=(const Texture2DArrayVisualizerPS&);
            Texture2DArrayVisualizerPS& operator=(Texture2DArrayVisualizerPS&&);

            TextureSRV textureArray;
