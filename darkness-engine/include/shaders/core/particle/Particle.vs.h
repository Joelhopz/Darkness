...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        namespace particlevs_namespace
        {
        struct ConstData
            {
        ...
        class ParticleVS : public VertexShader
            , public particlevs_namespace::ConstData
            {
        public:

            ParticleVS();

            ParticleVS(const ParticleVS&);
            ParticleVS(ParticleVS&&);
            ParticleVS& operator=(const ParticleVS&);
            ParticleVS& operator=(ParticleVS&&);
