...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        namespace particleps_namespace
        {
        struct ConstData
            {
        ...
        class ParticlePS : public PixelShader
            , public particleps_namespace::ConstData
            {
        public:

            ParticlePS();

            ParticlePS(const ParticlePS&);
            ParticlePS(ParticlePS&&);
            ParticlePS& operator=(const ParticlePS&);
            ParticlePS& operator=(ParticlePS&&);
            ...
            TextureSRV depth;
            TextureBindlessSRV diffuse;
            TextureBindlessSRV normal;
            TextureBindlessSRV alpha;
            TextureBindlessSRV top;
            TextureBindlessSRV left;
            TextureBindlessSRV bottom;
            TextureBindlessSRV right;
