...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        namespace ssaoblurps_namespace
        {
        struct Constants
            {
                Float2 texelSize;
        ...
        class SSAOBlurPS : public PixelShader
            , public ssaoblurps_namespace::Constants
            {
        public:

            SSAOBlurPS();

            SSAOBlurPS(const SSAOBlurPS&);
            SSAOBlurPS(SSAOBlurPS&&);
            SSAOBlurPS& operator=(const SSAOBlurPS&);
            SSAOBlurPS& operator=(SSAOBlurPS&&);

            TextureSRV image;
            BufferSRV blurKernel;
