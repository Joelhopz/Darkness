...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        class SSAOPS : public PixelShader
            , public ssaops_namespace::Constants
            {
        public:
            ...
            SSAOPS(const SSAOPS&);
            SSAOPS(SSAOPS&&);
            SSAOPS& operator=(const SSAOPS&);
            SSAOPS& operator=(SSAOPS&&);

            TextureSRV depthTexture;
            TextureSRV normalTexture;
            TextureSRV noiseTexture;
            BufferSRV samples;
