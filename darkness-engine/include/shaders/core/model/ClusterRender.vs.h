...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        namespace clusterrendervs_namespace
        {
        struct ConstData
            {
        ...
        class ClusterRenderVS : public VertexShader
            , public clusterrendervs_namespace::ConstData
            {
        public:

            ClusterRenderVS();

            ClusterRenderVS(const ClusterRenderVS&);
            ClusterRenderVS(ClusterRenderVS&&);
            ClusterRenderVS& operator=(const ClusterRenderVS&);
            ClusterRenderVS& operator=(ClusterRenderVS&&);
