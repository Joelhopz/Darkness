...
namespace engine
{
    ...
    namespace shaders
    {
        class ClusterShadowRenderer;

        namespace clustershadowrenderervs_namespace
        {
        struct ConstData
            {
        ...
        class ClusterShadowRendererVS : public VertexShader
            , public clustershadowrenderervs_namespace::ConstData
            {
        public:

            ClusterShadowRendererVS();

            ClusterShadowRendererVS(const ClusterShadowRendererVS&);
            ClusterShadowRendererVS(ClusterShadowRendererVS&&);
            ClusterShadowRendererVS& operator=(const ClusterShadowRendererVS&);
            ClusterShadowRendererVS& operator=(ClusterShadowRendererVS&&);
        ...
        private:
            friend class ClusterShadowRenderer;
