...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        class ClusterShadowRendererPS : public PixelShader
            {
        public:

            ClusterShadowRendererPS();

            ClusterShadowRendererPS(const ClusterShadowRendererPS&);
            ClusterShadowRendererPS(ClusterShadowRendererPS&&);
            ClusterShadowRendererPS& operator=(const ClusterShadowRendererPS&);
            ClusterShadowRendererPS& operator=(ClusterShadowRendererPS&&);
