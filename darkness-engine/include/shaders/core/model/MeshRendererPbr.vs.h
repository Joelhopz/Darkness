...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        namespace meshrendererpbrvs_namespace
        {
        struct ConstData
            {
        ...
        class MeshRendererPbrVS : public VertexShader
            , public meshrendererpbrvs_namespace::ConstData
            {
        public:

            MeshRendererPbrVS();

            MeshRendererPbrVS(const MeshRendererPbrVS&);
            MeshRendererPbrVS(MeshRendererPbrVS&&);
            MeshRendererPbrVS& operator=(const MeshRendererPbrVS&);
            MeshRendererPbrVS& operator=(MeshRendererPbrVS&&);
