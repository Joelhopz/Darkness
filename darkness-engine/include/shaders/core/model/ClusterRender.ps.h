...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        class ClusterRenderPS : public PixelShader
            {
        public:

            ClusterRenderPS();

            ClusterRenderPS(const ClusterRenderPS&);
            ClusterRenderPS(ClusterRenderPS&&);
            ClusterRenderPS& operator=(const ClusterRenderPS&);
            ClusterRenderPS& operator=(ClusterRenderPS&&);
