...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        class ShadowRenderTransparentPS : public PixelShader
            {
        public:

            ShadowRenderTransparentPS();

            ShadowRenderTransparentPS(const ShadowRenderTransparentPS&);
            ShadowRenderTransparentPS(ShadowRenderTransparentPS&&);
            ShadowRenderTransparentPS& operator=(const ShadowRenderTransparentPS&);
            ShadowRenderTransparentPS& operator=(ShadowRenderTransparentPS&&);

            TextureSRV transparencyMap;
