...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        class ShadowRenderPS : public PixelShader
            {
        public:

            ShadowRenderPS();

            ShadowRenderPS(const ShadowRenderPS&);
            ShadowRenderPS(ShadowRenderPS&&);
            ShadowRenderPS& operator=(const ShadowRenderPS&);
            ShadowRenderPS& operator=(ShadowRenderPS&&);
