...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        namespace shadowrendervs_namespace
        {
        struct ConstData
            {
        ...
        class ShadowRenderVS : public VertexShader
            , public shadowrendervs_namespace::ConstData
            {
        public:

            ShadowRenderVS();

            ShadowRenderVS(const ShadowRenderVS&);
            ShadowRenderVS(ShadowRenderVS&&);
            ShadowRenderVS& operator=(const ShadowRenderVS&);
            ShadowRenderVS& operator=(ShadowRenderVS&&);
