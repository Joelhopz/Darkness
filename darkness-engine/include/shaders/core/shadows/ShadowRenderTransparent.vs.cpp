...
#pragma warning( disable : 4702 )
        std::shared_ptr<const ShaderBinary> ShadowRenderTransparentVS::load(const Device& device, ShaderStorage& storage) const
        {
            ...
            return storage.loadShader(device, "C:/work/darkness/darkness-engine/data/shaders/vulkan/core/shadows/ShadowRenderTransparent.vs.spv", "C:/work/darkness/darkness-engine/data/shaders/vulkan/core/shadows/ShadowRenderTransparent.vs.support", -1, {});
...
#pragma warning( disable : 4100 )
        ShadowRenderTransparentVS::ShadowRenderTransparentVS(const ShadowRenderTransparentVS& cl)
            : m_constantRange{
...
#pragma warning( push )
#pragma warning( disable : 4100 )
        ShadowRenderTransparentVS::ShadowRenderTransparentVS(ShadowRenderTransparentVS&& cl)
            : m_constantRange{
...
#pragma warning( push )
#pragma warning( disable : 4100 )
        ShadowRenderTransparentVS& ShadowRenderTransparentVS::operator=(const ShadowRenderTransparentVS& cl)
        {
            for (int i = 0; i < m_constantRange.size(); ++i)
            {
                m_constantRange[i].buffer = cl.m_constantRange[i].buffer;
...
#pragma warning( push )
#pragma warning( disable : 4100 )
        ShadowRenderTransparentVS& ShadowRenderTransparentVS::operator=(ShadowRenderTransparentVS&& cl)
        {
            for (int i = 0; i < m_constantRange.size(); ++i)
            {
                m_constantRange[i].buffer = std::move(cl.m_constantRange[i].buffer);
...
#pragma warning( pop )
        ...
        std::vector<std::string> ShadowRenderTransparentVS::textureSrvNames() const
        {
            return {
        ...
        std::vector<std::string> ShadowRenderTransparentVS::textureUavNames() const
        {
            return {
        ...
        std::vector<std::string> ShadowRenderTransparentVS::bufferSrvNames() const
        {
            return {
        ...
        std::vector<std::string> ShadowRenderTransparentVS::bufferUavNames() const
        {
            return {
        ...
        std::vector<std::string> ShadowRenderTransparentVS::samplerNames() const
        {
            return {
        ...
        std::vector<std::string> ShadowRenderTransparentVS::srvNames() const
        {
            return {
        ...
        std::vector<std::string> ShadowRenderTransparentVS::uavNames() const
        {
            return {
...
#pragma warning( push )
#pragma warning( disable : 4100 )
        engine::ResourceDimension ShadowRenderTransparentVS::textureDimension(const std::string& name) const
        {
...
#pragma warning( pop )
        ...
        const std::vector<ShaderInputParameter>& ShadowRenderTransparentVS::inputParameters() const
        {
...
#pragma warning( disable : 4100 )
        ...
        void ShadowRenderTransparentVS::textureSrv(const std::string& name, TextureSRV& texture)
        {
            
            ASSERT(false, "Tried to set non-existing resource");
        }

        void ShadowRenderTransparentVS::textureUav(const std::string& name, TextureUAV& texture)
        {
            
            ASSERT(false, "Tried to set non-existing resource");
        }

        void ShadowRenderTransparentVS::bufferSrv(const std::string& name, BufferSRV& buffer)
        {
        ...
        void ShadowRenderTransparentVS::bufferUav(const std::string& name, BufferUAV& buffer)
        {
