...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        class MeshTransparentCompositeVS : public VertexShader
            {
        public:

            MeshTransparentCompositeVS();

            MeshTransparentCompositeVS(const MeshTransparentCompositeVS&);
            MeshTransparentCompositeVS(MeshTransparentCompositeVS&&);
            MeshTransparentCompositeVS& operator=(const MeshTransparentCompositeVS&);
            MeshTransparentCompositeVS& operator=(MeshTransparentCompositeVS&&);
