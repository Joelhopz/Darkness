...
namespace engine
{
    ...
    namespace shaders
    {
        class CreateOcclusionCullingArgs;

        class CreateOcclusionCullingArgsCS : public ComputeShader
            {
        public:

            CreateOcclusionCullingArgsCS();

            CreateOcclusionCullingArgsCS(const CreateOcclusionCullingArgsCS&);
            CreateOcclusionCullingArgsCS(CreateOcclusionCullingArgsCS&&);
            CreateOcclusionCullingArgsCS& operator=(const CreateOcclusionCullingArgsCS&);
            CreateOcclusionCullingArgsCS& operator=(CreateOcclusionCullingArgsCS&&);

            BufferSRV clusterCountBuffer;
            BufferUAV gatherDispatchArgs;
            BufferUAV occlusionDispatchArgs;
        ...
        private:
            friend class CreateOcclusionCullingArgs;
