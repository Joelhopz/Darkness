...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        class CullingCS : public ComputeShader
            , public cullingcs_namespace::CullingConstants
            {
        public:

            CullingCS();

            TextureBindlessSRV textures;
            BufferSRV clusterId;
            BufferSRV clusterIndexCount;
            BufferSRV clusterBounds;
            BufferUAV clusterIndexCountDraw;
