...
namespace engine
{
    ...
    namespace shaders
    {
        class CreateDrawArguments;

        class CreateDrawArgumentsCS : public ComputeShader
            {
        public:

            CreateDrawArgumentsCS();

            CreateDrawArgumentsCS(const CreateDrawArgumentsCS&);
            CreateDrawArgumentsCS(CreateDrawArgumentsCS&&);
            CreateDrawArgumentsCS& operator=(const CreateDrawArgumentsCS&);
            CreateDrawArgumentsCS& operator=(CreateDrawArgumentsCS&&);

            BufferSRV structureCounter;
        ...
        private:
            friend class CreateDrawArguments;
