...
namespace engine
{
    ...
    namespace shaders
    {
        class PrefixSumBuckets;

        class PrefixSumBucketsCS : public ComputeShader
            {
        public:

            PrefixSumBucketsCS();

            PrefixSumBucketsCS(const PrefixSumBucketsCS&);
            PrefixSumBucketsCS(PrefixSumBucketsCS&&);
            PrefixSumBucketsCS& operator=(const PrefixSumBucketsCS&);
            PrefixSumBucketsCS& operator=(PrefixSumBucketsCS&&);
