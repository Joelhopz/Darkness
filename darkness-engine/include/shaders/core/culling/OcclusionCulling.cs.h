...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        namespace occlusioncullingcs_namespace
        {
        ...
        class OcclusionCullingCS : public ComputeShader
            , public occlusioncullingcs_namespace::CullingConstants
            {
        public:

            OcclusionCullingCS();

            OcclusionCullingCS(const OcclusionCullingCS&);
            OcclusionCullingCS(OcclusionCullingCS&&);
            OcclusionCullingCS& operator=(const OcclusionCullingCS&);
            OcclusionCullingCS& operator=(OcclusionCullingCS&&);

            TextureSRV depthPyramid;
            BufferSRV frustumCullingOutput;
            BufferSRV boundingBoxes;
            BufferSRV transformHistory;
            BufferSRV clusterCount;
            BufferUAV cullingOutput;
            BufferUAV occlusionDrawArgs;
            BufferUAV distributor;
