...
namespace engine
{
    ...
    namespace shaders
    {
        class PrefixSumAddBuckets;

        class PrefixSumAddBucketsCS : public ComputeShader
            {
        public:

            PrefixSumAddBucketsCS();

            PrefixSumAddBucketsCS(const PrefixSumAddBucketsCS&);
            PrefixSumAddBucketsCS(PrefixSumAddBucketsCS&&);
            PrefixSumAddBucketsCS& operator=(const PrefixSumAddBucketsCS&);
            PrefixSumAddBucketsCS& operator=(PrefixSumAddBucketsCS&&);
        ...
        private:
            friend class PrefixSumAddBuckets;
