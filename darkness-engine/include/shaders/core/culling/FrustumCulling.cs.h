...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        namespace frustumcullingcs_namespace
        {
        ...
        class FrustumCullingCS : public ComputeShader
            , public frustumcullingcs_namespace::CullingConstants
            {
        public:

            FrustumCullingCS();

            FrustumCullingCS(const FrustumCullingCS&);
            FrustumCullingCS(FrustumCullingCS&&);
            FrustumCullingCS& operator=(const FrustumCullingCS&);
            FrustumCullingCS& operator=(FrustumCullingCS&&);

            BufferSRV subMeshBoundingBoxes;
            BufferSRV instanceSubMeshBinding;
            BufferSRV subMeshData;
            BufferSRV transformHistory;
            BufferUAV cullingOutput;
            BufferUAV clusterCountBuffer;
            BufferUAV outputAllocationShared;
