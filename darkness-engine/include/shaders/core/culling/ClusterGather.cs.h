...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        class ClusterGatherCS : public ComputeShader
            {
        public:

            ClusterGatherCS();

            ClusterGatherCS(const ClusterGatherCS&);
            ClusterGatherCS(ClusterGatherCS&&);
            ClusterGatherCS& operator=(const ClusterGatherCS&);
            ClusterGatherCS& operator=(ClusterGatherCS&&);

            BufferSRV clusterCountBuffer;
            BufferSRV frustumCullingOutput;
            BufferUAV clustersForOcclusionCulling;
