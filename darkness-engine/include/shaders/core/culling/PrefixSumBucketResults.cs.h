...
namespace engine
{
    ...
    namespace shaders
    {
        class PrefixSumBucketResults;

        class PrefixSumBucketResultsCS : public ComputeShader
            {
        public:

            PrefixSumBucketResultsCS();

            PrefixSumBucketResultsCS(const PrefixSumBucketResultsCS&);
            PrefixSumBucketResultsCS(PrefixSumBucketResultsCS&&);
            PrefixSumBucketResultsCS& operator=(const PrefixSumBucketResultsCS&);
            PrefixSumBucketResultsCS& operator=(PrefixSumBucketResultsCS&&);
        ...
        private:
            friend class PrefixSumBucketResults;
