...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        class CubemapVS : public VertexShader
            , public cubemapvs_namespace::ConstData
            {
        public:

            CubemapVS();

            CubemapVS(const CubemapVS&);
            CubemapVS(CubemapVS&&);
            CubemapVS& operator=(const CubemapVS&);
            CubemapVS& operator=(CubemapVS&&);
