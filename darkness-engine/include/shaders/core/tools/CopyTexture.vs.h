...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        class CopyTextureVS : public VertexShader
            {
        public:

            CopyTextureVS();

            CopyTextureVS(const CopyTextureVS&);
            CopyTextureVS(CopyTextureVS&&);
            CopyTextureVS& operator=(const CopyTextureVS&);
            CopyTextureVS& operator=(CopyTextureVS&&);
