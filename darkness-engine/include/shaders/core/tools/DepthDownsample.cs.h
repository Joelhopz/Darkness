...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        namespace depthdownsamplecs_namespace
        {
        struct Constants
            {
                Float2 size;
        ...
        class DepthDownsampleCS : public ComputeShader
            , public depthdownsamplecs_namespace::Constants
            {
        public:

            DepthDownsampleCS();

            DepthDownsampleCS(const DepthDownsampleCS&);
            DepthDownsampleCS(DepthDownsampleCS&&);
            DepthDownsampleCS& operator=(const DepthDownsampleCS&);
            DepthDownsampleCS& operator=(DepthDownsampleCS&&);
