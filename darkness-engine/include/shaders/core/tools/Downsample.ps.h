...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        namespace downsampleps_namespace
        {
        struct Constants
            {
                Float2 onePerSize;
        ...
        class DownsamplePS : public PixelShader
            , public downsampleps_namespace::Constants
            {
        public:

            DownsamplePS();

            DownsamplePS(const DownsamplePS&);
            DownsamplePS(DownsamplePS&&);
            DownsamplePS& operator=(const DownsamplePS&);
            DownsamplePS& operator=(DownsamplePS&&);
