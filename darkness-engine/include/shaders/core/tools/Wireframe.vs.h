...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        namespace wireframevs_namespace
        {
        struct ConstData
            {
        ...
        class WireframeVS : public VertexShader
            , public wireframevs_namespace::ConstData
            {
        public:

            WireframeVS();

            WireframeVS(const WireframeVS&);
            WireframeVS(WireframeVS&&);
            WireframeVS& operator=(const WireframeVS&);
            WireframeVS& operator=(WireframeVS&&);
