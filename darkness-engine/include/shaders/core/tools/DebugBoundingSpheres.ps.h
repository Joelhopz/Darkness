...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        class DebugBoundingSpheresPS : public PixelShader
            {
        public:

            DebugBoundingSpheresPS();

            DebugBoundingSpheresPS(const DebugBoundingSpheresPS&);
            DebugBoundingSpheresPS(DebugBoundingSpheresPS&&);
            DebugBoundingSpheresPS& operator=(const DebugBoundingSpheresPS&);
            DebugBoundingSpheresPS& operator=(DebugBoundingSpheresPS&&);
