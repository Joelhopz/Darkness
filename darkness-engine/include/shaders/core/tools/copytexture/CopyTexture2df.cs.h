...
namespace engine
{
    ...
    namespace shaders
    {
        class CopyTexture2df;

        namespace copytexture2dfcs_namespace
        {
        ...
        class CopyTexture2dfCS : public ComputeShader
            , public copytexture2dfcs_namespace::CopyConstants
            {
        public:

            CopyTexture2dfCS();

            CopyTexture2dfCS(const CopyTexture2dfCS&);
            CopyTexture2dfCS(CopyTexture2dfCS&&);
            CopyTexture2dfCS& operator=(const CopyTexture2dfCS&);
            CopyTexture2dfCS& operator=(CopyTexture2dfCS&&);
