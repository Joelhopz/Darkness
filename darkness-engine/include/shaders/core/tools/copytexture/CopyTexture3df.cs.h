...
namespace engine
{
    ...
    namespace shaders
    {
        class CopyTexture3df;

        namespace copytexture3dfcs_namespace
        {
        ...
        class CopyTexture3dfCS : public ComputeShader
            , public copytexture3dfcs_namespace::CopyConstants
            {
        public:

            CopyTexture3dfCS();

            CopyTexture3dfCS(const CopyTexture3dfCS&);
            CopyTexture3dfCS(CopyTexture3dfCS&&);
            CopyTexture3dfCS& operator=(const CopyTexture3dfCS&);
            CopyTexture3dfCS& operator=(CopyTexture3dfCS&&);
