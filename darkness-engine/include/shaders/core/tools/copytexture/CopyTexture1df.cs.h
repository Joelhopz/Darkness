...
namespace engine
{
    ...
    namespace shaders
    {
        class CopyTexture1df;

        namespace copytexture1dfcs_namespace
        {
        ...
        class CopyTexture1dfCS : public ComputeShader
            , public copytexture1dfcs_namespace::CopyConstants
            {
        public:

            CopyTexture1dfCS();

            CopyTexture1dfCS(const CopyTexture1dfCS&);
            CopyTexture1dfCS(CopyTexture1dfCS&&);
            CopyTexture1dfCS& operator=(const CopyTexture1dfCS&);
            CopyTexture1dfCS& operator=(CopyTexture1dfCS&&);
