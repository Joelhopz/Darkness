...
namespace engine
{
    ...
    namespace shaders
    {
        class DebugBoundingSpheres;

        namespace debugboundingspheresvs_namespace
        {
        struct ConstData
            {
                Float4x4 viewMatrix;
        ...
        class DebugBoundingSpheresVS : public VertexShader
            , public debugboundingspheresvs_namespace::ConstData
            {
        public:

            DebugBoundingSpheresVS();

            DebugBoundingSpheresVS(const DebugBoundingSpheresVS&);
            DebugBoundingSpheresVS(DebugBoundingSpheresVS&&);
            DebugBoundingSpheresVS& operator=(const DebugBoundingSpheresVS&);
            DebugBoundingSpheresVS& operator=(DebugBoundingSpheresVS&&);
        ...
        private:
            friend class DebugBoundingSpheres;
