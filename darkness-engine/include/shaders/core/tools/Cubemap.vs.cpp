...
namespace engine
{
    namespace shaders
    {
        ...
        {
            return storage.loadShader(device, "C:/work/darkness/darkness-engine/data/shaders/dx12/core/tools/Cubemap.vs.cso", "C:/work/darkness/darkness-engine/data/shaders/dx12/core/tools/Cubemap.vs.support");
        }
