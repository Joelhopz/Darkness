...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        namespace gaussianblurps_namespace
        {
        struct Constants
            {
                Float width;
        ...
        class GaussianBlurPS : public PixelShader
            , public gaussianblurps_namespace::Constants
            {
        public:

            GaussianBlurPS();

            GaussianBlurPS(const GaussianBlurPS&);
            GaussianBlurPS(GaussianBlurPS&&);
            GaussianBlurPS& operator=(const GaussianBlurPS&);
            GaussianBlurPS& operator=(GaussianBlurPS&&);
