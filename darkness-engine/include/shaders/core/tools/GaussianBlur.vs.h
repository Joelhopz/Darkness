...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        class GaussianBlurVS : public VertexShader
            {
        public:

            GaussianBlurVS();

            GaussianBlurVS(const GaussianBlurVS&);
            GaussianBlurVS(GaussianBlurVS&&);
            GaussianBlurVS& operator=(const GaussianBlurVS&);
            GaussianBlurVS& operator=(GaussianBlurVS&&);
