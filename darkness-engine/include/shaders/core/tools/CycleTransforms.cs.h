...
namespace engine
{
    ...
    namespace shaders
    {
        class CycleTransforms;

        namespace cycletransformscs_namespace
        {
        struct CycleTransformsConstants
            {
                Uint transformCount;
                };
        }
        class CycleTransformsCS : public ComputeShader
            , public cycletransformscs_namespace::CycleTransformsConstants
            {
        public:

            CycleTransformsCS();

            CycleTransformsCS(const CycleTransformsCS&);
            CycleTransformsCS(CycleTransformsCS&&);
            CycleTransformsCS& operator=(const CycleTransformsCS&);
            CycleTransformsCS& operator=(CycleTransformsCS&&);

            BufferUAV historyBuffer;
