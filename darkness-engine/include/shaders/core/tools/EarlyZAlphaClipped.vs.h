...
namespace engine
{
    ...
    namespace shaders
    {
        class EarlyZAlphaClipped;

        namespace earlyzalphaclippedvs_namespace
        {
        struct ConstData
            {
        ...
        class EarlyZAlphaClippedVS : public VertexShader
            , public earlyzalphaclippedvs_namespace::ConstData
            {
        public:

            EarlyZAlphaClippedVS();

            EarlyZAlphaClippedVS(const EarlyZAlphaClippedVS&);
            EarlyZAlphaClippedVS(EarlyZAlphaClippedVS&&);
            EarlyZAlphaClippedVS& operator=(const EarlyZAlphaClippedVS&);
            EarlyZAlphaClippedVS& operator=(EarlyZAlphaClippedVS&&);
        ...
        private:
            friend class EarlyZAlphaClipped;
