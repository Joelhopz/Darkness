...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        class AddTexturesVS : public VertexShader
            {
        public:

            AddTexturesVS();

            AddTexturesVS(const AddTexturesVS&);
            AddTexturesVS(AddTexturesVS&&);
            AddTexturesVS& operator=(const AddTexturesVS&);
            AddTexturesVS& operator=(AddTexturesVS&&);
