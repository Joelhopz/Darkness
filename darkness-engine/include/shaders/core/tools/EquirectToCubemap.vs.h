...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        namespace equirecttocubemapvs_namespace
        {
        struct ConstData
            {
        ...
        class EquirectToCubemapVS : public VertexShader
            , public equirecttocubemapvs_namespace::ConstData
            {
        public:

            EquirectToCubemapVS();

            EquirectToCubemapVS(const EquirectToCubemapVS&);
            EquirectToCubemapVS(EquirectToCubemapVS&&);
            EquirectToCubemapVS& operator=(const EquirectToCubemapVS&);
            EquirectToCubemapVS& operator=(EquirectToCubemapVS&&);
        ...
        private:
            friend class EquirectToCubemap;
