...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        class PickCS : public ComputeShader
            , public pickcs_namespace::PickConstants
            {
        public:
            ...
            PickCS(const PickCS&);
            PickCS(PickCS&&);
            PickCS& operator=(const PickCS&);
            PickCS& operator=(PickCS&&);

            TextureSRV instanceId;
            BufferUAV output;
