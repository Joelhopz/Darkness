...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        class EquirectToCubemapPS : public PixelShader
            {
        public:

            EquirectToCubemapPS();

            EquirectToCubemapPS(const EquirectToCubemapPS&);
            EquirectToCubemapPS(EquirectToCubemapPS&&);
            EquirectToCubemapPS& operator=(const EquirectToCubemapPS&);
            EquirectToCubemapPS& operator=(EquirectToCubemapPS&&);

            TextureSRV equirectangularMap;
