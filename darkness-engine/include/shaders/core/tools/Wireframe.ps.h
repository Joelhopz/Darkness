...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        namespace wireframeps_namespace
        {
        struct ConstData
            {
                Float4 color;
        ...
        class WireframePS : public PixelShader
            , public wireframeps_namespace::ConstData
            {
        public:

            WireframePS();

            WireframePS(const WireframePS&);
            WireframePS(WireframePS&&);
            WireframePS& operator=(const WireframePS&);
            WireframePS& operator=(WireframePS&&);
