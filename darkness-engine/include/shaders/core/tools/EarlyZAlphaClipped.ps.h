...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        class EarlyZAlphaClippedPS : public PixelShader
            {
        public:

            EarlyZAlphaClippedPS();

            EarlyZAlphaClippedPS(const EarlyZAlphaClippedPS&);
            EarlyZAlphaClippedPS(EarlyZAlphaClippedPS&&);
            EarlyZAlphaClippedPS& operator=(const EarlyZAlphaClippedPS&);
            EarlyZAlphaClippedPS& operator=(EarlyZAlphaClippedPS&&);
