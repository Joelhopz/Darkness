...
namespace engine
{
    ...
    namespace shaders
    {
        class ClearTexture3du4;

        namespace cleartexture3du4cs_namespace
        {
        ...
        class ClearTexture3du4CS : public ComputeShader
            , public cleartexture3du4cs_namespace::ClearConstants
            {
        public:

            ClearTexture3du4CS();

            ClearTexture3du4CS(const ClearTexture3du4CS&);
            ClearTexture3du4CS(ClearTexture3du4CS&&);
            ClearTexture3du4CS& operator=(const ClearTexture3du4CS&);
            ClearTexture3du4CS& operator=(ClearTexture3du4CS&&);
