...
namespace engine
{
    ...
    namespace shaders
    {
        class ClearTexture2df2;

        namespace cleartexture2df2cs_namespace
        {
        ...
        class ClearTexture2df2CS : public ComputeShader
            , public cleartexture2df2cs_namespace::ClearConstants
            {
        public:

            ClearTexture2df2CS();

            ClearTexture2df2CS(const ClearTexture2df2CS&);
            ClearTexture2df2CS(ClearTexture2df2CS&&);
            ClearTexture2df2CS& operator=(const ClearTexture2df2CS&);
            ClearTexture2df2CS& operator=(ClearTexture2df2CS&&);
