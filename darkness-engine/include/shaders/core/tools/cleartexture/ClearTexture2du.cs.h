...
namespace engine
{
    ...
    namespace shaders
    {
        class ClearTexture2du;

        namespace cleartexture2ducs_namespace
        {
        ...
        class ClearTexture2duCS : public ComputeShader
            , public cleartexture2ducs_namespace::ClearConstants
            {
        public:

            ClearTexture2duCS();

            ClearTexture2duCS(const ClearTexture2duCS&);
            ClearTexture2duCS(ClearTexture2duCS&&);
            ClearTexture2duCS& operator=(const ClearTexture2duCS&);
            ClearTexture2duCS& operator=(ClearTexture2duCS&&);
