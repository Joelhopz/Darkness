...
namespace engine
{
    ...
    namespace shaders
    {
        class ClearTexture2df3;

        namespace cleartexture2df3cs_namespace
        {
        ...
        class ClearTexture2df3CS : public ComputeShader
            , public cleartexture2df3cs_namespace::ClearConstants
            {
        public:

            ClearTexture2df3CS();

            ClearTexture2df3CS(const ClearTexture2df3CS&);
            ClearTexture2df3CS(ClearTexture2df3CS&&);
            ClearTexture2df3CS& operator=(const ClearTexture2df3CS&);
            ClearTexture2df3CS& operator=(ClearTexture2df3CS&&);
