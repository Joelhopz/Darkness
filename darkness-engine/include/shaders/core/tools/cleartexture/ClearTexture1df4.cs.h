...
namespace engine
{
    ...
    namespace shaders
    {
        class ClearTexture1df4;

        namespace cleartexture1df4cs_namespace
        {
        ...
        class ClearTexture1df4CS : public ComputeShader
            , public cleartexture1df4cs_namespace::ClearConstants
            {
        public:

            ClearTexture1df4CS();

            ClearTexture1df4CS(const ClearTexture1df4CS&);
            ClearTexture1df4CS(ClearTexture1df4CS&&);
            ClearTexture1df4CS& operator=(const ClearTexture1df4CS&);
            ClearTexture1df4CS& operator=(ClearTexture1df4CS&&);
