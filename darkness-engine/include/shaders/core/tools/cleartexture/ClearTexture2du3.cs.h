...
namespace engine
{
    ...
    namespace shaders
    {
        class ClearTexture2du3;

        namespace cleartexture2du3cs_namespace
        {
        ...
        class ClearTexture2du3CS : public ComputeShader
            , public cleartexture2du3cs_namespace::ClearConstants
            {
        public:

            ClearTexture2du3CS();

            ClearTexture2du3CS(const ClearTexture2du3CS&);
            ClearTexture2du3CS(ClearTexture2du3CS&&);
            ClearTexture2du3CS& operator=(const ClearTexture2du3CS&);
            ClearTexture2du3CS& operator=(ClearTexture2du3CS&&);
