...
namespace engine
{
    ...
    namespace shaders
    {
        class ClearTexture2df;

        namespace cleartexture2dfcs_namespace
        {
        ...
        class ClearTexture2dfCS : public ComputeShader
            , public cleartexture2dfcs_namespace::ClearConstants
            {
        public:

            ClearTexture2dfCS();

            ClearTexture2dfCS(const ClearTexture2dfCS&);
            ClearTexture2dfCS(ClearTexture2dfCS&&);
            ClearTexture2dfCS& operator=(const ClearTexture2dfCS&);
            ClearTexture2dfCS& operator=(ClearTexture2dfCS&&);
