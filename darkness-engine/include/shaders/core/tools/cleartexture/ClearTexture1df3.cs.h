...
namespace engine
{
    ...
    namespace shaders
    {
        class ClearTexture1df3;

        namespace cleartexture1df3cs_namespace
        {
        ...
        class ClearTexture1df3CS : public ComputeShader
            , public cleartexture1df3cs_namespace::ClearConstants
            {
        public:

            ClearTexture1df3CS();

            ClearTexture1df3CS(const ClearTexture1df3CS&);
            ClearTexture1df3CS(ClearTexture1df3CS&&);
            ClearTexture1df3CS& operator=(const ClearTexture1df3CS&);
            ClearTexture1df3CS& operator=(ClearTexture1df3CS&&);
