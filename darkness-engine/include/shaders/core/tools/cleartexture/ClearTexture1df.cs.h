...
namespace engine
{
    ...
    namespace shaders
    {
        class ClearTexture1df;

        namespace cleartexture1dfcs_namespace
        {
        ...
        class ClearTexture1dfCS : public ComputeShader
            , public cleartexture1dfcs_namespace::ClearConstants
            {
        public:

            ClearTexture1dfCS();

            ClearTexture1dfCS(const ClearTexture1dfCS&);
            ClearTexture1dfCS(ClearTexture1dfCS&&);
            ClearTexture1dfCS& operator=(const ClearTexture1dfCS&);
            ClearTexture1dfCS& operator=(ClearTexture1dfCS&&);
