...
namespace engine
{
    ...
    namespace shaders
    {
        class ClearTexture3df2;

        namespace cleartexture3df2cs_namespace
        {
        ...
        class ClearTexture3df2CS : public ComputeShader
            , public cleartexture3df2cs_namespace::ClearConstants
            {
        public:

            ClearTexture3df2CS();

            ClearTexture3df2CS(const ClearTexture3df2CS&);
            ClearTexture3df2CS(ClearTexture3df2CS&&);
            ClearTexture3df2CS& operator=(const ClearTexture3df2CS&);
            ClearTexture3df2CS& operator=(ClearTexture3df2CS&&);
