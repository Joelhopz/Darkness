...
namespace engine
{
    ...
    namespace shaders
    {
        class ClearTexture2du4;

        namespace cleartexture2du4cs_namespace
        {
        ...
        class ClearTexture2du4CS : public ComputeShader
            , public cleartexture2du4cs_namespace::ClearConstants
            {
        public:

            ClearTexture2du4CS();

            ClearTexture2du4CS(const ClearTexture2du4CS&);
            ClearTexture2du4CS(ClearTexture2du4CS&&);
            ClearTexture2du4CS& operator=(const ClearTexture2du4CS&);
            ClearTexture2du4CS& operator=(ClearTexture2du4CS&&);
