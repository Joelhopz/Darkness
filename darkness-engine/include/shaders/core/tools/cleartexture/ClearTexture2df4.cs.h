...
namespace engine
{
    ...
    namespace shaders
    {
        class ClearTexture2df4;

        namespace cleartexture2df4cs_namespace
        {
        ...
        class ClearTexture2df4CS : public ComputeShader
            , public cleartexture2df4cs_namespace::ClearConstants
            {
        public:

            ClearTexture2df4CS();

            ClearTexture2df4CS(const ClearTexture2df4CS&);
            ClearTexture2df4CS(ClearTexture2df4CS&&);
            ClearTexture2df4CS& operator=(const ClearTexture2df4CS&);
            ClearTexture2df4CS& operator=(ClearTexture2df4CS&&);
