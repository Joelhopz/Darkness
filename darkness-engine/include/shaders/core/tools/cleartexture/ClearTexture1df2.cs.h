...
namespace engine
{
    ...
    namespace shaders
    {
        class ClearTexture1df2;

        namespace cleartexture1df2cs_namespace
        {
        ...
        class ClearTexture1df2CS : public ComputeShader
            , public cleartexture1df2cs_namespace::ClearConstants
            {
        public:

            ClearTexture1df2CS();

            ClearTexture1df2CS(const ClearTexture1df2CS&);
            ClearTexture1df2CS(ClearTexture1df2CS&&);
            ClearTexture1df2CS& operator=(const ClearTexture1df2CS&);
            ClearTexture1df2CS& operator=(ClearTexture1df2CS&&);
