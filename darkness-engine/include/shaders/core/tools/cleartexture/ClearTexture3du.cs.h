...
namespace engine
{
    ...
    namespace shaders
    {
        class ClearTexture3du;

        namespace cleartexture3ducs_namespace
        {
        ...
        class ClearTexture3duCS : public ComputeShader
            , public cleartexture3ducs_namespace::ClearConstants
            {
        public:

            ClearTexture3duCS();

            ClearTexture3duCS(const ClearTexture3duCS&);
            ClearTexture3duCS(ClearTexture3duCS&&);
            ClearTexture3duCS& operator=(const ClearTexture3duCS&);
            ClearTexture3duCS& operator=(ClearTexture3duCS&&);
