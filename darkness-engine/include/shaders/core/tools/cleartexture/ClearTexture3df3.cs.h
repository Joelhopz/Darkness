...
namespace engine
{
    ...
    namespace shaders
    {
        class ClearTexture3df3;

        namespace cleartexture3df3cs_namespace
        {
        ...
        class ClearTexture3df3CS : public ComputeShader
            , public cleartexture3df3cs_namespace::ClearConstants
            {
        public:

            ClearTexture3df3CS();

            ClearTexture3df3CS(const ClearTexture3df3CS&);
            ClearTexture3df3CS(ClearTexture3df3CS&&);
            ClearTexture3df3CS& operator=(const ClearTexture3df3CS&);
            ClearTexture3df3CS& operator=(ClearTexture3df3CS&&);
