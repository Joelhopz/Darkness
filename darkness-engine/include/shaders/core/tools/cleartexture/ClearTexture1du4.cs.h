...
namespace engine
{
    ...
    namespace shaders
    {
        class ClearTexture1du4;

        namespace cleartexture1du4cs_namespace
        {
        ...
        class ClearTexture1du4CS : public ComputeShader
            , public cleartexture1du4cs_namespace::ClearConstants
            {
        public:

            ClearTexture1du4CS();

            ClearTexture1du4CS(const ClearTexture1du4CS&);
            ClearTexture1du4CS(ClearTexture1du4CS&&);
            ClearTexture1du4CS& operator=(const ClearTexture1du4CS&);
            ClearTexture1du4CS& operator=(ClearTexture1du4CS&&);
