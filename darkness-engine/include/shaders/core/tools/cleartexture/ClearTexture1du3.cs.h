...
namespace engine
{
    ...
    namespace shaders
    {
        class ClearTexture1du3;

        namespace cleartexture1du3cs_namespace
        {
        ...
        class ClearTexture1du3CS : public ComputeShader
            , public cleartexture1du3cs_namespace::ClearConstants
            {
        public:

            ClearTexture1du3CS();

            ClearTexture1du3CS(const ClearTexture1du3CS&);
            ClearTexture1du3CS(ClearTexture1du3CS&&);
            ClearTexture1du3CS& operator=(const ClearTexture1du3CS&);
            ClearTexture1du3CS& operator=(ClearTexture1du3CS&&);
