...
namespace engine
{
    ...
    namespace shaders
    {
        class ClearTexture2du2;

        namespace cleartexture2du2cs_namespace
        {
        ...
        class ClearTexture2du2CS : public ComputeShader
            , public cleartexture2du2cs_namespace::ClearConstants
            {
        public:

            ClearTexture2du2CS();

            ClearTexture2du2CS(const ClearTexture2du2CS&);
            ClearTexture2du2CS(ClearTexture2du2CS&&);
            ClearTexture2du2CS& operator=(const ClearTexture2du2CS&);
            ClearTexture2du2CS& operator=(ClearTexture2du2CS&&);
