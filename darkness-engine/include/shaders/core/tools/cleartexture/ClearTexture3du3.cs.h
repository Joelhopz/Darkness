...
namespace engine
{
    ...
    namespace shaders
    {
        class ClearTexture3du3;

        namespace cleartexture3du3cs_namespace
        {
        ...
        class ClearTexture3du3CS : public ComputeShader
            , public cleartexture3du3cs_namespace::ClearConstants
            {
        public:

            ClearTexture3du3CS();

            ClearTexture3du3CS(const ClearTexture3du3CS&);
            ClearTexture3du3CS(ClearTexture3du3CS&&);
            ClearTexture3du3CS& operator=(const ClearTexture3du3CS&);
            ClearTexture3du3CS& operator=(ClearTexture3du3CS&&);
