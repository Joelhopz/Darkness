...
namespace engine
{
    ...
    namespace shaders
    {
        class ClearTexture3df4;

        namespace cleartexture3df4cs_namespace
        {
        ...
        class ClearTexture3df4CS : public ComputeShader
            , public cleartexture3df4cs_namespace::ClearConstants
            {
        public:

            ClearTexture3df4CS();

            ClearTexture3df4CS(const ClearTexture3df4CS&);
            ClearTexture3df4CS(ClearTexture3df4CS&&);
            ClearTexture3df4CS& operator=(const ClearTexture3df4CS&);
            ClearTexture3df4CS& operator=(ClearTexture3df4CS&&);
