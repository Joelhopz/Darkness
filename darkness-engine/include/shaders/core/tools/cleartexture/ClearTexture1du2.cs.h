...
namespace engine
{
    ...
    namespace shaders
    {
        class ClearTexture1du2;

        namespace cleartexture1du2cs_namespace
        {
        ...
        class ClearTexture1du2CS : public ComputeShader
            , public cleartexture1du2cs_namespace::ClearConstants
            {
        public:

            ClearTexture1du2CS();

            ClearTexture1du2CS(const ClearTexture1du2CS&);
            ClearTexture1du2CS(ClearTexture1du2CS&&);
            ClearTexture1du2CS& operator=(const ClearTexture1du2CS&);
            ClearTexture1du2CS& operator=(ClearTexture1du2CS&&);
