...
namespace engine
{
    ...
    namespace shaders
    {
        class ClearTexture1du;

        namespace cleartexture1ducs_namespace
        {
        ...
        class ClearTexture1duCS : public ComputeShader
            , public cleartexture1ducs_namespace::ClearConstants
            {
        public:

            ClearTexture1duCS();

            ClearTexture1duCS(const ClearTexture1duCS&);
            ClearTexture1duCS(ClearTexture1duCS&&);
            ClearTexture1duCS& operator=(const ClearTexture1duCS&);
            ClearTexture1duCS& operator=(ClearTexture1duCS&&);
