...
namespace engine
{
    ...
    namespace shaders
    {
        class ClearTexture3du2;

        namespace cleartexture3du2cs_namespace
        {
        ...
        class ClearTexture3du2CS : public ComputeShader
            , public cleartexture3du2cs_namespace::ClearConstants
            {
        public:

            ClearTexture3du2CS();

            ClearTexture3du2CS(const ClearTexture3du2CS&);
            ClearTexture3du2CS(ClearTexture3du2CS&&);
            ClearTexture3du2CS& operator=(const ClearTexture3du2CS&);
            ClearTexture3du2CS& operator=(ClearTexture3du2CS&&);
