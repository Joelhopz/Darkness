...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        class EarlyZVS : public VertexShader
            , public earlyzvs_namespace::ConstData
            {
        public:

            EarlyZVS();

            EarlyZVS(const EarlyZVS&);
            EarlyZVS(EarlyZVS&&);
            EarlyZVS& operator=(const EarlyZVS&);
            EarlyZVS& operator=(EarlyZVS&&);
