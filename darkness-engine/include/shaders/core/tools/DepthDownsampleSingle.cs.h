...
namespace engine
{
    ...
    namespace shaders
    {
        class DepthDownsampleSingle;

        namespace depthdownsamplesinglecs_namespace
        {
        struct Constants
            {
                Float2 size;
        ...
        class DepthDownsampleSingleCS : public ComputeShader
            , public depthdownsamplesinglecs_namespace::Constants
            {
        public:

            DepthDownsampleSingleCS();

            DepthDownsampleSingleCS(const DepthDownsampleSingleCS&);
            DepthDownsampleSingleCS(DepthDownsampleSingleCS&&);
            DepthDownsampleSingleCS& operator=(const DepthDownsampleSingleCS&);
            DepthDownsampleSingleCS& operator=(DepthDownsampleSingleCS&&);
        ...
        private:
            friend class DepthDownsampleSingle;
