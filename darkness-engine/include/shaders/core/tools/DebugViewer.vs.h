...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        namespace debugviewervs_namespace
        {
        struct ConstData
            {
                Float width;
        ...
        class DebugViewerVS : public VertexShader
            , public debugviewervs_namespace::ConstData
            {
        public:

            DebugViewerVS();

            DebugViewerVS(const DebugViewerVS&);
            DebugViewerVS(DebugViewerVS&&);
            DebugViewerVS& operator=(const DebugViewerVS&);
            DebugViewerVS& operator=(DebugViewerVS&&);
