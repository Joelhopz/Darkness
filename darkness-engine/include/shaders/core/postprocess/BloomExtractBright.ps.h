...
namespace engine
{
    ...
    namespace shaders
    {
        class BloomExtractBright;

        namespace bloomextractbrightps_namespace
        {
        ...
        class BloomExtractBrightPS : public PixelShader
            , public bloomextractbrightps_namespace::BloomExtractConstants
            {
        public:

            BloomExtractBrightPS();

            BloomExtractBrightPS(const BloomExtractBrightPS&);
            BloomExtractBrightPS(BloomExtractBrightPS&&);
            BloomExtractBrightPS& operator=(const BloomExtractBrightPS&);
            BloomExtractBrightPS& operator=(BloomExtractBrightPS&&);

            TextureSRV framebuffer;
        ...
        private:
            friend class BloomExtractBright;
