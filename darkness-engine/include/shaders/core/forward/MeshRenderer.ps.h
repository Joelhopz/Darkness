...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        namespace meshrendererps_namespace
        {
        struct ConstData
            {
        ...
        class MeshRendererPS : public PixelShader
            , public meshrendererps_namespace::ConstData
            {
        public:

            MeshRendererPS();

            MeshRendererPS(const MeshRendererPS&);
            MeshRendererPS(MeshRendererPS&&);
            MeshRendererPS& operator=(const MeshRendererPS&);
            MeshRendererPS& operator=(MeshRendererPS&&);
