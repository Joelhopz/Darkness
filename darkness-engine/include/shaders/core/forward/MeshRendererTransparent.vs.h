...
namespace engine
{
    ...
    namespace shaders
    {
        class MeshRendererTransparent;

        namespace meshrenderertransparentvs_namespace
        {
        struct ConstData
            {
        ...
        class MeshRendererTransparentVS : public VertexShader
            , public meshrenderertransparentvs_namespace::ConstData
            {
        public:

            MeshRendererTransparentVS();

            MeshRendererTransparentVS(const MeshRendererTransparentVS&);
            MeshRendererTransparentVS(MeshRendererTransparentVS&&);
            MeshRendererTransparentVS& operator=(const MeshRendererTransparentVS&);
            MeshRendererTransparentVS& operator=(MeshRendererTransparentVS&&);
        ...
        private:
            friend class MeshRendererTransparent;
