...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        namespace meshrenderertransparentps_namespace
        {
        struct ConstData
            {
        ...
        class MeshRendererTransparentPS : public PixelShader
            , public meshrenderertransparentps_namespace::ConstData
            {
        public:

            MeshRendererTransparentPS();

            MeshRendererTransparentPS(const MeshRendererTransparentPS&);
            MeshRendererTransparentPS(MeshRendererTransparentPS&&);
            MeshRendererTransparentPS& operator=(const MeshRendererTransparentPS&);
            MeshRendererTransparentPS& operator=(MeshRendererTransparentPS&&);
