...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        namespace irradiancevs_namespace
        {
        struct ConstData
            {
        ...
        class IrradianceVS : public VertexShader
            , public irradiancevs_namespace::ConstData
            {
        public:

            IrradianceVS();

            IrradianceVS(const IrradianceVS&);
            IrradianceVS(IrradianceVS&&);
            IrradianceVS& operator=(const IrradianceVS&);
            IrradianceVS& operator=(IrradianceVS&&);
