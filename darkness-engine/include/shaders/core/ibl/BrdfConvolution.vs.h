...
namespace engine
{
    ...
    namespace shaders
    {
        class BrdfConvolution;

        class BrdfConvolutionVS : public VertexShader
            {
        public:

            BrdfConvolutionVS();

            BrdfConvolutionVS(const BrdfConvolutionVS&);
            BrdfConvolutionVS(BrdfConvolutionVS&&);
            BrdfConvolutionVS& operator=(const BrdfConvolutionVS&);
            BrdfConvolutionVS& operator=(BrdfConvolutionVS&&);
