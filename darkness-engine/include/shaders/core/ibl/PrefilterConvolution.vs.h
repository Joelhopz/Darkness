...
namespace engine
{
    ...
    namespace shaders
    {
        class PrefilterConvolution;

        namespace prefilterconvolutionvs_namespace
        {
        struct ConstData
            {
        ...
        class PrefilterConvolutionVS : public VertexShader
            , public prefilterconvolutionvs_namespace::ConstData
            {
        public:

            PrefilterConvolutionVS();

            PrefilterConvolutionVS(const PrefilterConvolutionVS&);
            PrefilterConvolutionVS(PrefilterConvolutionVS&&);
            PrefilterConvolutionVS& operator=(const PrefilterConvolutionVS&);
            PrefilterConvolutionVS& operator=(PrefilterConvolutionVS&&);
        ...
        private:
            friend class PrefilterConvolution;
