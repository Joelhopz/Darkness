...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        namespace prefilterconvolutionps_namespace
        {
        struct ConstData
            {
                Float roughness;
        ...
        class PrefilterConvolutionPS : public PixelShader
            , public prefilterconvolutionps_namespace::ConstData
            {
        public:

            PrefilterConvolutionPS();

            PrefilterConvolutionPS(const PrefilterConvolutionPS&);
            PrefilterConvolutionPS(PrefilterConvolutionPS&&);
            PrefilterConvolutionPS& operator=(const PrefilterConvolutionPS&);
            PrefilterConvolutionPS& operator=(PrefilterConvolutionPS&&);
