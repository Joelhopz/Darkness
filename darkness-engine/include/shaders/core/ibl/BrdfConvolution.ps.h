...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        class BrdfConvolutionPS : public PixelShader
            {
        public:

            BrdfConvolutionPS();

            BrdfConvolutionPS(const BrdfConvolutionPS&);
            BrdfConvolutionPS(BrdfConvolutionPS&&);
            BrdfConvolutionPS& operator=(const BrdfConvolutionPS&);
            BrdfConvolutionPS& operator=(BrdfConvolutionPS&&);
