...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        class OutlinePS : public PixelShader
            , public outlineps_namespace::ConstData
            {
        public:

            OutlinePS();

            OutlinePS(const OutlinePS&);
            OutlinePS(OutlinePS&&);
            OutlinePS& operator=(const OutlinePS&);
            OutlinePS& operator=(OutlinePS&&);
