...
namespace engine
{
    ...
    namespace shaders
    {
        class CreateOutlineIndirectIndexedDrawArgs;

        namespace createoutlineindirectindexeddrawargscs_namespace
        {
        ...
        class CreateOutlineIndirectIndexedDrawArgsCS : public ComputeShader
            , public createoutlineindirectindexeddrawargscs_namespace::OutlineConstants
            {
        public:

            CreateOutlineIndirectIndexedDrawArgsCS();

            CreateOutlineIndirectIndexedDrawArgsCS(const CreateOutlineIndirectIndexedDrawArgsCS&);
            CreateOutlineIndirectIndexedDrawArgsCS(CreateOutlineIndirectIndexedDrawArgsCS&&);
            CreateOutlineIndirectIndexedDrawArgsCS& operator=(const CreateOutlineIndirectIndexedDrawArgsCS&);
            CreateOutlineIndirectIndexedDrawArgsCS& operator=(CreateOutlineIndirectIndexedDrawArgsCS&&);

            BufferSRV subMeshBinding;
            BufferSRV subMeshAdjacency;
            BufferUAV indexedDrawArguments;
        ...
        private:
            friend class CreateOutlineIndirectIndexedDrawArgs;
