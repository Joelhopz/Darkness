...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        class OutlineGS : public GeometryShader
            , public outlinegs_namespace::ConstData
            {
        public:

            OutlineGS();

            OutlineGS(const OutlineGS&);
            OutlineGS(OutlineGS&&);
            OutlineGS& operator=(const OutlineGS&);
            OutlineGS& operator=(OutlineGS&&);
