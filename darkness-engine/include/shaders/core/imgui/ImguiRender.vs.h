...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        namespace imguirendervs_namespace
        {
        ...
        class ImguiRenderVS : public VertexShader
            , public imguirendervs_namespace::constants_struct
            {
        public:

            ImguiRenderVS();

            ImguiRenderVS(const ImguiRenderVS&);
            ImguiRenderVS(ImguiRenderVS&&);
            ImguiRenderVS& operator=(const ImguiRenderVS&);
            ImguiRenderVS& operator=(ImguiRenderVS&&);
