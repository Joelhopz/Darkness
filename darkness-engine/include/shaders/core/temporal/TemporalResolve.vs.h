...
namespace engine
{
    ...
    namespace shaders
    {
        ...
        class TemporalResolveVS : public VertexShader
            {
        public:

            TemporalResolveVS();

            TemporalResolveVS(const TemporalResolveVS&);
            TemporalResolveVS(TemporalResolveVS&&);
            TemporalResolveVS& operator=(const TemporalResolveVS&);
            TemporalResolveVS& operator=(TemporalResolveVS&&);
