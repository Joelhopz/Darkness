...
namespace engine
{
    CombineTextures::CombineTextures(Device& device, ShaderStorage& shaderStorage)
        : m_device{ device }
        , m_addTexturesPipeline{ device.createPipeline<shaders::AddTextures>(shaderStorage) }
    {
