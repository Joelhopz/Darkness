...
namespace engine
{
    DownsampleTool::DownsampleTool(Device& device, ShaderStorage& shaderStorage)
        : m_device{ device }
        , m_downsamplePipeline{ device.createPipeline<shaders::Downsample>(shaderStorage) }
    {
