...
namespace engine
{
    ...
    std::vector<uint32_t> getSisters(uint32_t indiceIndex,
        const std::vector<uint32_t>& indices, const std::vector<Vector3f>& vertices)
    {
        ...
        uint32_t startingIndex)
    {
        ...
        else
        {
            ...
            // build adjacency buffer
            //std::vector<uint32_t> adjacencyData(indexCount * 2);
            int adjacencyIndex = 0;
