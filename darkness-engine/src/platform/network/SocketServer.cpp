...
namespace platform
{
    ...
    /*std::shared_ptr<Socket>& SocketServer::socket()
    {
        return m_serverSocket;
    }*/

    void SocketServer::sendMessage(std::shared_ptr<platform::Socket> socket, const NetworkMessage& message)
    {
    ...
    std::string SocketServer::ip() const
    {
