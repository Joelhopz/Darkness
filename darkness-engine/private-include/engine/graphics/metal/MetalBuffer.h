...
namespace engine
{
    ...
    namespace implementation
    {
        ...
        protected:
            ...
            std::shared_ptr<MetalBuffer> m_buffer{ nullptr };
            std::shared_ptr<MetalDeviceMemory> m_memory{ nullptr };
        };
        ...
        protected:
            ...
            std::shared_ptr<MetalBufferView> m_view{ nullptr };
            std::shared_ptr<MetalDeviceMemory> m_memory{ nullptr };
        };
        ...
        protected:
            ...
            std::shared_ptr<MetalTexture> m_image{ nullptr };
            std::shared_ptr<MetalDeviceMemory> m_memory{ nullptr };
        };
        ...
        private:
            const TextureDescription::Descriptor m_description;
            std::shared_ptr<MetalTextureView> m_view{ nullptr };
            Texture m_texture;
        };
